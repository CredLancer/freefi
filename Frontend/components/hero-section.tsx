/**
 * v0 by Vercel.
 * @see https://v0.dev/t/jGEmo5UJ92c
 */
import { Button } from "@/components/ui/button"

export default function HeroSection() {
  return (
    <div className="bg-gradient-to-r from-purple-300 via-pink-300 to-purple-300 h-screen flex flex-col items-center justify-center text-center px-4">
